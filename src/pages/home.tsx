...
const Home = () => (
    <>
        ...
        <section className="  px-6 lg:px-8 ">
            <div className=" shadow-md rounded-lg text-center p-10 my-10 lg:m-40">
                ...
                <div className="mt-10 flex items-center justify-center gap-x-6">
                    <Link to="/projects" className="rounded-md bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">View Projects</Link>
                    <Link to="/tech stack"  className="text-sm/6 font-semibold text-gray-900">Tech stack</Link>
                </div>
            </div>
        </section>
        <section className="  px-6 lg:px-8 ">
        ...
        <section className=" isolate px-6 lg:px-8 ">
            <div className="container mx-auto p-10 flex flex-col lg:flex-row items-center gap-10">
                <div className="w-full lg:w-1/2 text-center shadow-md">
